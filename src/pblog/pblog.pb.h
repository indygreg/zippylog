...
// source: pblog/pblog.proto

#ifndef PROTOBUF_pblog_2fpblog_2eproto__INCLUDED
#define PROTOBUF_pblog_2fpblog_2eproto__INCLUDED
...
class Message : public ::google::protobuf::Message {
 public:
  ...
  inline const ::pblog::ActorInfo& actors(int index) const;
  inline ::pblog::ActorInfo* mutable_actors(int index);
  inline ::pblog::ActorInfo* add_actors();
  inline const ::google::protobuf::RepeatedPtrField< ::pblog::ActorInfo >&
      actors() const;
  inline ::google::protobuf::RepeatedPtrField< ::pblog::ActorInfo >*
      mutable_actors();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::pblog::ActorInfo > actors_;
  ::google::protobuf::uint64 numeric_value_;
  friend void  protobuf_AddDesc_pblog_2fpblog_2eproto();
  friend void protobuf_AssignDesc_pblog_2fpblog_2eproto();
  friend void protobuf_ShutdownFile_pblog_2fpblog_2eproto();
...
// repeated bytes messages = 1;
inline int Message::messages_size() const {
  return messages_.size();
}
inline void Message::clear_messages() {
  messages_.Clear();
}
inline const ::std::string& Message::messages(int index) const {
  return messages_.Get(index);
}
inline ::std::string* Message::mutable_messages(int index) {
  return messages_.Mutable(index);
}
inline void Message::set_messages(int index, const ::std::string& value) {
  messages_.Mutable(index)->assign(value);
}
inline void Message::set_messages(int index, const char* value) {
  messages_.Mutable(index)->assign(value);
}
inline void Message::set_messages(int index, const void* value, size_t size) {
  messages_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
}
inline ::std::string* Message::add_messages() {
  return messages_.Add();
}
inline void Message::add_messages(const ::std::string& value) {
  messages_.Add()->assign(value);
}
inline void Message::add_messages(const char* value) {
  messages_.Add()->assign(value);
}
inline void Message::add_messages(const void* value, size_t size) {
  messages_.Add()->assign(reinterpret_cast<const char*>(value), size);
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
Message::messages() const {
  return messages_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Message::mutable_messages() {
  return &messages_;
}

// repeated uint32 message_namespaces = 2 [packed = true];
inline int Message::message_namespaces_size() const {
  return message_namespaces_.size();
}
inline void Message::clear_message_namespaces() {
  message_namespaces_.Clear();
}
inline ::google::protobuf::uint32 Message::message_namespaces(int index) const {
  return message_namespaces_.Get(index);
}
inline void Message::set_message_namespaces(int index, ::google::protobuf::uint32 value) {
  message_namespaces_.Set(index, value);
}
inline void Message::add_message_namespaces(::google::protobuf::uint32 value) {
  message_namespaces_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
Message::message_namespaces() const {
  return message_namespaces_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
Message::mutable_message_namespaces() {
  return &message_namespaces_;
}

// repeated uint32 message_types = 3 [packed = true];
inline int Message::message_types_size() const {
  return message_types_.size();
}
inline void Message::clear_message_types() {
  message_types_.Clear();
}
inline ::google::protobuf::uint32 Message::message_types(int index) const {
  return message_types_.Get(index);
}
inline void Message::set_message_types(int index, ::google::protobuf::uint32 value) {
  message_types_.Set(index, value);
}
inline void Message::add_message_types(::google::protobuf::uint32 value) {
  message_types_.Add(value);
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >&
Message::message_types() const {
  return message_types_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::uint32 >*
Message::mutable_message_types() {
  return &message_types_;
}
...
inline ::google::protobuf::uint64 Message::create_time() const {
  return create_time_;
}
inline void Message::set_create_time(::google::protobuf::uint64 value) {
  _set_bit(3);
  create_time_ = value;
}

// repeated bytes tags = 5;
inline int Message::tags_size() const {
  return tags_.size();
}
inline void Message::clear_tags() {
  tags_.Clear();
}
inline const ::std::string& Message::tags(int index) const {
  return tags_.Get(index);
}
inline ::std::string* Message::mutable_tags(int index) {
  return tags_.Mutable(index);
}
inline void Message::set_tags(int index, const ::std::string& value) {
  tags_.Mutable(index)->assign(value);
}
inline void Message::set_tags(int index, const char* value) {
  tags_.Mutable(index)->assign(value);
}
inline void Message::set_tags(int index, const void* value, size_t size) {
  tags_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
}
inline ::std::string* Message::add_tags() {
  return tags_.Add();
}
inline void Message::add_tags(const ::std::string& value) {
  tags_.Add()->assign(value);
}
inline void Message::add_tags(const char* value) {
  tags_.Add()->assign(value);
}
inline void Message::add_tags(const void* value, size_t size) {
...
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Message::mutable_tags() {
  return &tags_;
}

// repeated .pblog.ActorInfo actors = 6;
inline int Message::actors_size() const {
  return actors_.size();
}
inline void Message::clear_actors() {
  actors_.Clear();
}
inline const ::pblog::ActorInfo& Message::actors(int index) const {
  return actors_.Get(index);
}
inline ::pblog::ActorInfo* Message::mutable_actors(int index) {
  return actors_.Mutable(index);
}
inline ::pblog::ActorInfo* Message::add_actors() {
  return actors_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::pblog::ActorInfo >&
Message::actors() const {
  return actors_;
}
inline ::google::protobuf::RepeatedPtrField< ::pblog::ActorInfo >*
Message::mutable_actors() {
  return &actors_;
}

// optional uint64 numeric_value = 7;
inline bool Message::has_numeric_value() const {
  return _has_bit(6);
}
inline void Message::clear_numeric_value() {
  numeric_value_ = GOOGLE_ULONGLONG(0);
  _clear_bit(6);
}
inline ::google::protobuf::uint64 Message::numeric_value() const {
  return numeric_value_;
}
inline void Message::set_numeric_value(::google::protobuf::uint64 value) {
  _set_bit(6);
...
#endif  // PROTOBUF_pblog_2fpblog_2eproto__INCLUDED
