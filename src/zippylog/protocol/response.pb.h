...
class PluginUnregisterAckV1 : public ::google::protobuf::Message {
 public:
  PluginUnregisterAckV1();
  virtual ~PluginUnregisterAckV1();
  
  PluginUnregisterAckV1(const PluginUnregisterAckV1& from);
  
  inline PluginUnregisterAckV1& operator=(const PluginUnregisterAckV1& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const PluginUnregisterAckV1& default_instance();
  
  void Swap(PluginUnregisterAckV1* other);
  
  // implements Message ----------------------------------------------
  
  PluginUnregisterAckV1* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const PluginUnregisterAckV1& from);
  void MergeFrom(const PluginUnregisterAckV1& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static PluginUnregisterAckV1* default_instance_;
};
// -------------------------------------------------------------------
...
// required string name = 1;
inline bool PluginUnregisterAckV1::has_name() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void PluginUnregisterAckV1::set_has_name() {
  _has_bits_[0] |= 0x00000001u;
}
inline void PluginUnregisterAckV1::clear_has_name() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void PluginUnregisterAckV1::clear_name() {
  if (name_ != &::google::protobuf::internal::kEmptyString) {
    name_->clear();
  }
  clear_has_name();
}
inline const ::std::string& PluginUnregisterAckV1::name() const {
  return *name_;
}
inline void PluginUnregisterAckV1::set_name(const ::std::string& value) {
  set_has_name();
  if (name_ == &::google::protobuf::internal::kEmptyString) {
    name_ = new ::std::string;
  }
...
inline void PluginUnregisterAckV1::set_name(const char* value) {
  set_has_name();
  if (name_ == &::google::protobuf::internal::kEmptyString) {
    name_ = new ::std::string;
  }
...
inline void PluginUnregisterAckV1::set_name(const char* value, size_t size) {
  set_has_name();
  if (name_ == &::google::protobuf::internal::kEmptyString) {
    name_ = new ::std::string;
  }
...
inline ::std::string* PluginUnregisterAckV1::mutable_name() {
  set_has_name();
  if (name_ == &::google::protobuf::internal::kEmptyString) {
    name_ = new ::std::string;
  }
...
inline ::std::string* PluginUnregisterAckV1::release_name() {
  clear_has_name();
  if (name_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
