...
void protobuf_AddDesc_pblog_2fpblogd_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\022pblog/pblogd.proto\022\014pblog.pblogd\"=\n\rBr"
...
bool BrokerStartup::add_to_envelope(::pblog::Envelope *envelope) {
    return envelope->add_message(this, pblog_namespace, pblog_enumeration);
}

bool BrokerShutdown::add_to_envelope(::pblog::Envelope *envelope) {
    return envelope->add_message(this, pblog_namespace, pblog_enumeration);
}

bool BrokerReceiveClientMessage::add_to_envelope(::pblog::Envelope *envelope) {
    return envelope->add_message(this, pblog_namespace, pblog_enumeration);
}
