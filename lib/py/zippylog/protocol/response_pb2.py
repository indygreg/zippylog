...
_SUBSCRIPTIONACCEPTACKV1 = descriptor.Descriptor(
  name='SubscriptionAcceptAckV1',
  full_name='zippylog.protocol.response.SubscriptionAcceptAckV1',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='id', full_name='zippylog.protocol.response.SubscriptionAcceptAckV1.id', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='ttl', full_name='zippylog.protocol.response.SubscriptionAcceptAckV1.ttl', index=1,
      number=2, type=13, cpp_type=3, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SUBSCRIPTIONKEEPALIVEACKV1 = descriptor.Descriptor(
  name='SubscriptionKeepaliveAckV1',
  full_name='zippylog.protocol.response.SubscriptionKeepaliveAckV1',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='id', full_name='zippylog.protocol.response.SubscriptionKeepaliveAckV1.id', index=0,
      number=1, type=12, cpp_type=9, label=2,
      has_default_value=False, default_value="",
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PLUGINREGISTERACKV1 = descriptor.Descriptor(
  name='PluginRegisterAckV1',
  full_name='zippylog.protocol.response.PluginRegisterAckV1',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='zippylog.protocol.response.PluginRegisterAckV1.name', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PLUGINSTATUSV1 = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      name='state', full_name='zippylog.protocol.response.PluginStatusV1.state', index=0,
...
DESCRIPTOR.message_types_by_name['SubscriptionAcceptAckV1'] = _SUBSCRIPTIONACCEPTACKV1
DESCRIPTOR.message_types_by_name['SubscriptionKeepaliveAckV1'] = _SUBSCRIPTIONKEEPALIVEACKV1
...
class SubscriptionAcceptAckV1(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _SUBSCRIPTIONACCEPTACKV1
  
  ZIPPYLOG_NAMESPACE = 1
  ZIPPYLOG_ENUMERATION = 109
  # @@protoc_insertion_point(class_scope:zippylog.protocol.response.SubscriptionAcceptAckV1)

class SubscriptionKeepaliveAckV1(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _SUBSCRIPTIONKEEPALIVEACKV1
...
class PluginRegisterAckV1(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _PLUGINREGISTERACKV1
