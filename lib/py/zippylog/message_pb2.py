...
_ENVELOPE = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='string_value', full_name='zippylog.message.Envelope.string_value', index=7,
